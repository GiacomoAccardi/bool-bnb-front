    ...
    <div class="container margin">
      ...
      <div class="row">
        ...
        >
          ...
          >
            <div class="card mb-3 mt-3" style="height:320px;" :class="{ 'border-wow': realEstate.subscriptions.length > 0 }">
              <div class="row">
                <div class="col-12">
  ...
  export default {
    ...
    computed: {
      filteredRealEstates() {
        ...
        return this.realEstates.filter(realEstate => realEstate.city === this.city);
      }
    },
    async created() {
      try {
